...
public class CalendarBersama extends Schedule implements Priority {

    public CalendarBersama(String id, String tipe, String tanggal, String waktu, String kegiatan, String prioritas) {
        this.id = id;
        this.tipe = tipe;
